...
const UserDetails = () => {
  ...
  return (
    <aside
      ...
      } overflow transition top-0 h-screen z-10 bg-white border-2 shadow-md right-0 p-8 fixed capitalize text-gray-700 w-[90%] md:w-[75%] lg:w-[50%]`}
    >
      <img
      ...
      <div className='flex flex-col sm:flex-row justify-between my-4'>
        ...
        <button className='p-2 px-4 w-fit h-fit text-xs border-2 border-[#7805A7] text-[#7805A7] rounded-md'>
          Contact Vendor
        </button>
      </div>
      <div className='my-2'>
